...
function getWebPageManifest() {
  var _a;
  const origin = (_a = getWindow$2()) === null || _a === void 0 ? void 0 : _a.location.origin;
  if (origin) {
...
var TonConnectUIError = class extends TonConnectError {
  constructor(...args) {
    super(...args);
  ...
  subscribeToWalletChange() {
    this.connector.onStatusChange((wallet) => __async(this, null, function* () {
      ...
      if (wallet) {
        ...
        this.setPreferredWalletName(((_a = this.walletInfo) == null ? void 0 : _a.name) || wallet.device.appName);
      } else {
        this.walletInfoStorage.removeWalletInfo();
      }
    }));
...
@tonconnect/ui/lib/index.js:
  ...
  *)
*/
//# sourceMappingURL=@tonconnect_ui.js.map
